...
public class C01_StringBuilder {
   ...
   3) Ayni anda bir cok isin yapilmasina "multi threading" denir. "multi" = Cok, "thread"= Yapilan islerin herbiri
  	Multi threading varsa, bu islerin siraya konulmasi lazim.Islerin siraya konulmasina "synchronization" denir.
        ...
        String str="javaCAN";
        System.out.println("metot öncesi str = " + str);

        strBirlestir(str);

        System.out.println("metot sonrası str = " + str);//immutable olduğu için değişmedi.

        //TODO task -> 50000 tekrarlı bir loop ile String ve StringBuilder obj run time surelerini karsılatırın
        ...
        System.out.println("str1Bit = " + str1Bit);
        ...
        LocalTime sb1Bit= LocalTime.now();
        System.out.println("sb1Bit = " + sb1Bit);
