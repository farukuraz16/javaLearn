 ...
 */
    ...
    public static void topla(int sayi1, int sayi2) {
        System.out.println("int-int type method working-->" + (sayi1 + sayi2));
    }

    public static void topla(double sayi1, int sayi2) {
        System.out.println("double-int type method working-->" + (sayi1 + sayi2));
    }

    public static void topla(int sayi1, double sayi2) {
        System.out.println("int-double type method working-->" + (sayi1 + sayi2));
    }

    public static void topla(double sayi1, double sayi2) {
        System.out.println("double-double type method working-->" + (sayi1 + sayi2));
    }
