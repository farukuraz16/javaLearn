package j25_Encapsulation.encapsulation_01;
/*
		 ...
		 todo    ahan da  TRICK : Tum variable'lar private ve sadece getter() method tanımlanan  class'da
...
public class C01_Encapsulation {
    public static void main(String[] args) {
        ...
        System.out.println("obj1.idVer() = " + obj1.getId());
        ...
        obj2.setName("Gamze srum master");
        System.out.println("obj2.isimVer() = " + obj2.getName());
