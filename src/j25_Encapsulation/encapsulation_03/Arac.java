package j25_Encapsulation.encapsulation_03;
...
/*
   ...
   5- aracların motor hacmi 1000 cc ve altı olması ve yılını hatalı veri girisine karsi kontrol ediniz.
    ...
    public Arac(String model, String renk, int motor, int yıl) {
        ...
        this.renk = renk;
        //this.motor = motor;
        setMotor(motor);//constructor'dan motoru kotrol ederek çağırmak için metodu buraya ekliyoruz.
        //this.yıl = yıl;
        setYıl(yıl);
    }
    ...
    public void setMotor(int motor) {
        if (motor > 1000) {
            this.motor = motor;
        } else this.motor= motor+ (1000 - motor);
    }
