...
public class C01_ArrayList {
    public static void main(String[] args) {
        ...
        int sayi = 33;//tek bir data saklayan variable
        int sayi1[] = new int[5]; //5 değer saklar
        int sayi2[][] = new int[5][6]; //30 tane değer saklar
        ArrayList<Integer> sayiList = new ArrayList<>(); //istediğiniz kadar değer saklar
/*
...
//list create etme ve değer atama
        ...
        listSayi.add(10);//ilk eleman eklendi.
        System.out.println(listSayi);
        listSayi.add(39);
        listSayi.add(72);
        listSayi.add(61);
        listSayi.add(41);
        listSayi.add(41);//aynı değeri tekrar girebiliriz...
        System.out.println(listSayi);
