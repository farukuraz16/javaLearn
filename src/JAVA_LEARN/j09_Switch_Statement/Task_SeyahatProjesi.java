   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
         ...
         */
        int kolnbirim = 80 / 20 * 5;
        int franbirim = 60 / 20 * 5;
        double bakiye = 5000;

        Scanner scan = new Scanner(System.in);
        System.out.println("***** seyahat şirketimize hos geldiniz *****");
        System.out.println("Frankfurt: 60 km \nKoln: 80 km \n Her 20 Km basına 5 euro ucretlendirme yapılır :) ");

        System.out.print("yolculuk yapacagınız sehri seciniz : ");
        String hedef = scan.next().toUpperCase();
        System.out.print("kaç kişilik bilet almak istiyorsunuz? (max 2 kişi)= ");
        int kisi = scan.nextInt();

        switch (hedef){
            case "KÖLN":
                System.out.println("Rotanız: "+hedef+"\nyolcu sayısı: "+kisi+"\nücret= "+(kisi*kolnbirim));
                System.out.println("bakiyeniz= "+bakiye+"\nparaüstü= "+(bakiye-(kisi*kolnbirim)));
                break;
            case "FRANKFURT" :
                System.out.println("Rotanız: "+hedef+"\nyolcu sayısı: "+kisi+"\nücret= "+(kisi*franbirim));
                System.out.println("bakiyeniz= "+bakiye+"\nparaüstü= "+(bakiye-(kisi*franbirim)));break;
            default: System.out.println("hatalı şehir adı");break;
        }
