...
public class MyConstructor_v2 {
    int x=3;
    int y=5;
    public MyConstructor_v2() {
        x+=1;//ins variable +1 update edildi
        System.out.println("-x"+x);
    }
    public MyConstructor_v2(int i ){
    ...
    public MyConstructor_v2(int i, int i2) {
        this(3);//int p'li cons.  parametre 3 atanarak call edildi
        this.x -= 4;//inst. x variable -4  uodate edildi
        System.out.println("-x"+x);
    }
    public static void main(String[] args) {
        MyConstructor_v2 mc1= new MyConstructor_v2(4,3);//2 int parametre 4 ve 3 atanarak cons. call edildi
    }
}
