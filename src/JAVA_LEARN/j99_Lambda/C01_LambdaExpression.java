...
printElFunctional1(sayi);
    ...
    //todo Task : "Structured Programming":Amele code kullanarak list elemanlarını aynı satirda aralarında bosluk olacak sekilde print ediniz.
    ...
    //todo Task : "Functional Programming":cincix code kullanarak list elemanlarını aynı satirda aralarında bosluk olacak sekilde print ediniz.
    ...
    public static void printElFunctional2(List<Integer> sayi) {//functional pr
        sayi.//aksiyona girecek list coll.
                stream().//List elemanlarını yukarıdan aşağıya akısa alır.
                forEach(C01_LambdaExpression::yazdır);//Method refernece->System.out yapısından print meth call edildi
        //MethodKkaynagı::Method ->meth reference
    }
