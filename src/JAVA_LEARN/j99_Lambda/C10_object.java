...
public class C10_object {
    ...
    public static void main(String[] args) {
        Universite u01 = new Universite("Bogazici","Psikoloji",20, 75);
        ...
        System.out.println("\n   ***   ");
        System.out.println("Task02 : " + ogrcSys110azMi(unv));
        System.out.println("\n   ***   ");
        ...
        System.out.println("\n   ***   ");
        System.out.println("Task06 : "+enAzOgrcSays2Unv(unv));
        System.out.println("\n   ***   ");
        System.out.println("Task07 : "+notOrt63BykOgrcSysToplam(unv));
        System.out.println("\n   ***   ");
        System.out.println("Task08 : "+ogrcSys333BykNotOrtOrt(unv));
        System.out.println("\n   ***   ");
        System.out.println("Task09 -Matematik bölümü sayısı : "+matBolumSayisi(unv));
        System.out.println("\n   ***   ");
        System.out.println("Task10 -en büyük not ort(öğrncisayısı 571den büyük : "+enBuyukNotOrt(unv));
        System.out.println("\n   ***   ");
        System.out.println("Task11 -enKucukNotOrt(unv) = " + enKucukNotOrt(unv));
...
public static List<Universite> ogrcSysTersSıra(List<Universite>unv){
    ...
    public static long matBolumSayisi(List<Universite>unv){
        return unv.stream().filter(t->t.getBolum().toLowerCase().contains("matematik")).count();

    }

//task 10-->Ogrenci sayilari 571'dan fazla olan universite'lerin en buyuk notOrt'unu bulunuz.
public static int enBuyukNotOrt(List<Universite>unv){
    ...
    public static int enKucukNotOrt(List<Universite>unv){
        return unv.stream().filter(t->t.getOgrcSayisi()<1071).
                sorted(Comparator.comparing(Universite::getNotOrt)).
                limit(1).mapToInt(t->t.getNotOrt()).sum();
