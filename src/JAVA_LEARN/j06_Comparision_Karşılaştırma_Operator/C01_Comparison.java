package JAVA_LEARN.j06_Comparision_Karşılaştırma_Operator;
...
public class C01_Comparison {
    ...
    >=	    buyuk esit        	x >= y
    <=	    kücük esit  	    x <= y
    bu comparisonlar kullanıldığında sonucu boolean değer verir. yani boolean yazmamıza gerek kalamadan true-false
    sonucu verir.
     */
